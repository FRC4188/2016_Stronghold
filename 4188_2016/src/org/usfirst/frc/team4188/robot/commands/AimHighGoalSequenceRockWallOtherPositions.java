 ...
 *
 */
public class AimHighGoalSequenceRockWallOtherPositions extends CommandGroup {
    
    public  AimHighGoalSequenceRockWallOtherPositions(String side) {
        // Add Commands here:
    	...
    	addSequential(new MoveToAngle(3.0,180),2);
